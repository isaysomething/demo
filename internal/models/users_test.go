...
var (
	userDBTypes = map[string]string{`ID`: `bigint`, `Username`: `varchar`, `Email`: `varchar`, `VerificationToken`: `char`, `HashedPassword`: `varchar`, `PasswordResetToken`: `char`, `State`: `int`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`, `DeletedAt`: `datetime`}
	_           = bytes.MinRead
)
