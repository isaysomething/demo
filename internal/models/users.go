...
var UserWhere = struct {
	...
	PasswordResetToken: whereHelpernull_String{field: "`users`.`password_reset_token`"},
	State:              whereHelperint{field: "`users`.`state`"},
...
var (
	userAllColumns            = []string{"id", "username", "email", "verification_token", "hashed_password", "password_reset_token", "state", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"username", "email", "verification_token", "hashed_password", "password_reset_token", "created_at", "updated_at", "deleted_at"}
	userColumnsWithDefault    = []string{"id", "state"}
