...
var PostWhere = struct {
	...
	State:     whereHelperint{field: "`posts`.`state`"},
...
var (
	postAllColumns            = []string{"id", "state", "user_id", "title", "content", "created_at", "updated_at"}
	postColumnsWithoutDefault = []string{"user_id", "title", "content", "created_at", "updated_at"}
	postColumnsWithDefault    = []string{"id", "state"}
