...
(null, 'p', 'admin', '/v1/posts', 'GET'),
(null, 'p', 'admin', '/v1/posts', 'POST'),
(null, 'p', 'admin', '/v1/posts/*', 'GET'),
(null, 'p', 'admin', '/v1/posts/*', 'PUT|PATCH'),
(null, 'p', 'admin', '/v1/posts/*', 'DELETE'),

(null, 'p', 'admin', '/v1/users', 'GET'),
(null, 'p', 'admin', '/v1/users', 'POST'),
(null, 'p', 'admin', '/v1/users/*', 'GET'),
(null, 'p', 'admin', '/v1/users/*', 'PUT|PATCH'),
(null, 'p', 'admin', '/v1/users/*', 'DELETE'),

(null, 'p', 'admin', '/v1/roles', 'GET'),
(null, 'p', 'admin', '/v1/roles', 'POST'),
(null, 'p', 'admin', '/v1/roles/*', 'GET'),
(null, 'p', 'admin', '/v1/roles/*', 'PUT|PATCH'),
(null, 'p', 'admin', '/v1/roles/*', 'DELETE'),
